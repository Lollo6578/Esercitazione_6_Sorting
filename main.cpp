...
using namespace std;
    ...
    int main(int argc, char *argv[])
    {
        ...
        // cout << "v3: " << endl;   // cout << ArrayToString(v3) << endl;
    ...
    double time_elapsed_heapsort_v1 = 0.0;
    for(unsigned int t = 0; t < num_experiment; t++)
    {
        vector<int> v(v1);
        ...
        std::chrono::steady_clock::time_point end_time = std::chrono::steady_clock::now();
        time_elapsed_heapsort_v1 += std::chrono::duration_cast<std::chrono::microseconds>(end_time - start_time).count();
    }
    time_elapsed_heapsort_v1 /= num_experiment;

    cout << "HeapSort - v1: " << time_elapsed_heapsort_v1 << endl;

    double time_elapsed_heapsort_v2 = 0.0;
    for(unsigned int t = 0; t < num_experiment; t++)
    {
        vector<double> v(v2);
        ...
        std::chrono::steady_clock::time_point end_time = std::chrono::steady_clock::now();
        time_elapsed_heapsort_v2 += std::chrono::duration_cast<std::chrono::microseconds>(end_time - start_time).count();
    }
    time_elapsed_heapsort_v2 /= num_experiment;

    cout << "Heapsort - v2: " << time_elapsed_heapsort_v2 << endl;


    double time_elapsed_heapsort_v3 = 0.0;
    for(unsigned int t = 0; t < num_experiment; t++)
    {
        vector<int> v(v3);
        ...
        SortLibrary::HeapSort<int>(v);
        std::chrono::steady_clock::time_point end_time = std::chrono::steady_clock::now();
        time_elapsed_heapsort_v3 += std::chrono::duration_cast<std::chrono::microseconds>(end_time - start_time).count();
    }
    time_elapsed_heapsort_v3 /= num_experiment;

    cout << "Heap Sort - v3: " << time_elapsed_heapsort_v3 << endl;
    return 0;
    }
